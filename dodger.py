...
RunLeft = [pygame.transform.scale(pygame.image.load('Standing.png'), (233,160)), pygame.image.load('RL2.png'), pygame.image.load('RL3.png'), pygame.image.load('RL4.png'), pygame.image.load('RL5.png'), pygame.image.load('RL6.png'), pygame.image.load('RL7.png'), pygame.image.load('RL8.png'), pygame.image.load('RL9.png'),pygame.image.load('RL10.png'),pygame.image.load('RL11.png')]
